...
public class BlockusFamilies {
    ...
    static {
        ...
        WAXED_COPPERED_TUFF_BRICKS = register(BlockusBlocks.COPPER_TUFF_BRICKS.blockWaxed).slab(BlockusBlocks.COPPER_TUFF_BRICKS.slabWaxed).stairs(BlockusBlocks.COPPER_TUFF_BRICKS.stairsWaxed).wall(BlockusBlocks.COPPER_TUFF_BRICKS.wallWaxed).group("waxed_copper_tuff_bricks").noGenerateModels().build();
        ...
        WAXED_EXPOSED_COPPERED_TUFF_BRICKS = register(BlockusBlocks.EXPOSED_COPPER_TUFF_BRICKS.blockWaxed).slab(BlockusBlocks.EXPOSED_COPPER_TUFF_BRICKS.slabWaxed).stairs(BlockusBlocks.EXPOSED_COPPER_TUFF_BRICKS.stairsWaxed).wall(BlockusBlocks.EXPOSED_COPPER_TUFF_BRICKS.wallWaxed).group("waxed_exposed_copper_tuff_bricks").noGenerateModels().build();
